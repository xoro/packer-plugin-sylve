...
// StepDiscoverIP discovers the VM's IP address by polling the Sylve DHCP lease
// API until the guest's MAC address appears. The discovered IP is stored under
// "instance_ip" for StepConnect.
